...
out_folder <- "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_t2_BCT_vol_2.0/"
...
```{r}
if (generate == TRUE){
  models_folder <- "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_t2_BCT_vol_2.0/"
...
split 1
sbatch array_script_submit.sh submit_gamlss_fits_ABCD_ONE.sh /mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_t2_BCT_vol_2.0 "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_t2_BCT_vol_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/CSV/process_tables_5.1_2.0/abcd_long_Onetrain2025-06-16.csv" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_t2_BCT_vol_splitONE_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_t2_BCT_vol_splitONE_2.0/gamlss_fits_stats" "t2"

split 2
sbatch array_script_submit.sh submit_gamlss_fits_ABCD_TWO.sh /mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_t2_BCT_vol_2.0 "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_t2_BCT_vol_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/CSV/process_tables_5.1_2.0/abcd_long_Twotrain2025-06-16.csv" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_t2_BCT_vol_splitTWO_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_t2_BCT_vol_splitTWO_2.0/gamlss_fits_stats" "t2"
#Data Setup
##Define files
```{r}
#file paths
splitOne_folder <- paste0(fits_path, "gamlss_fits_t2_BCT_vol_splitONE_2.0/")
splitTwo_folder <- paste0(fits_path, "gamlss_fits_t2_BCT_vol_splitTWO_2.0/")
...
```{r}
all_fits_filename <- paste0(fits_path, "t2_BCT_fits.csv")
if(save_fits == TRUE){
...
if(save_best_models == TRUE){
  filename_sOne <- paste0(fits_path, "t2.sOne_best_models_index.csv")
  write.csv(sOne_best_list, filename_sOne)
  filename_sTwo <- paste0(fits_path, "t2.sTwo_best_models_index.csv")
...
##save table as csv
filename <- "t2.sOne.modelparams.csv"
...
##save table as csv
filename <- "t2.sTwo.modelparams.csv"
if (!dir.exists(paste0(fits_path, "model_params_tables/"))) dir.create(paste0(fits_path, "model_params_tables/"))
