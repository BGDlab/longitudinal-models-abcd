...
out_folder <- "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_long_vol_2.0/"
...
split 1
sbatch array_script_submit.sh submit_gamlss_fits_ABCD_ONE.sh /mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_long_vol_2.0 "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_long_vol_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/CSV/process_tables_5.1_2.0/abcd_long_Onetrain2025-06-16.csv" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_long_vol_splitONE_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_long_vol_splitONE_2.0/gamlss_fits_stats" "long"

split 2
sbatch array_script_submit.sh submit_gamlss_fits_ABCD_TWO.sh /mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_long_vol_2.0 "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_models_long_vol_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/CSV/process_tables_5.1_2.0/abcd_long_Twotrain2025-06-16.csv" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_long_vol_splitTWO_2.0/" "/mnt/isilon/bgdlab_processing/Eren/ABCD-braincharts/3.0_results/gamlss_fits_long_vol_splitTWO_2.0/gamlss_fits_stats" "long"
...
splitOne_train_filename <- paste0(data_path, "abcd_wide_Onetrain2025-10-03.csv")
splitTwo_train_filename <- paste0(data_path, "abcd_wide_Twotrain2025-10-03.csv")
splitOne_test_filename <- paste0(data_path, "abcd_wide_Onetest2025-10-03.csv")
splitTwo_test_filename <- paste0(data_path, "abcd_wide_Twotest2025-10-03.csv")
```
...
if(save_best_models == TRUE){
  filename_sOne <- paste0(fits_path, "long.sOne_best_models_index.csv")
  write.csv(sOne_best_list, filename_sOne)
  filename_sTwo <- paste0(fits_path, "long.sTwo_best_models_index.csv")
...
names(sOne_model_params_df) <- c("group","column_name", "family", "BIC", "mu_intercept", "mu_age", "mu_sexM", "mu_agesexM","mu_randomsite_var", "mu_randomsite_std", "mu_randomsite_lambda",
...
sOne_model_params_df$group <- ifelse(sub(".t2","", sOne_model_params_df$column_name) %in% all_global_phenotypes, "global", "region")
...
sOne_model_params_df$column_name <- sub(".t2", "", sOne_model_params_df$column_name)
...
sTwo_model_params_df$group <- ifelse(sub(".t2", "", sTwo_model_params_df$column_name) %in% all_global_phenotypes, "global", "region")
...
sTwo_model_params_df$column_name <- sub(".t2", "", sTwo_model_params_df$column_name)
